...
4. If the LLM returns a different number of blocks than it received, the chunk is sent again (up to 3 attempts).
...
``` bash
python srt_ollama_translator.py movie.srt movie_pl.srt gemma3:12b --from-lang auto --to-lang Polish
```
